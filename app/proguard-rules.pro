...
#2.默认保留区 保持哪些类不被混淆
-keep public class * extends android.baseApp.Fragment
-keep public class * extends android.support.v4.baseApp.Fragment
-keep public class * extends android.baseApp.Activity
-keep public class * extends android.support.v7.baseApp.AppCompatActivity
-keep public class * extends android.baseApp.Application
-keep public class * extends android.support.multidex.MultiDexApplication.MultiDexApplication
-keep public class * extends android.baseApp.Service
-keep public class * extends android.content.BroadcastReceiver
-keep public class * extends android.content.ContentProvider
-keep public class * extends android.baseApp.backup.BackupAgentHelper
-keep public class * extends android.preference.Preference
-keep public class * extends android.view.View
-keep public class * extends android.baseApp.Dialog
...
#保持自定义控件类不被混淆
-keepclassmembers class * extends android.baseApp.Activity{
...
#--1.实体类---------------------------------
#实体类一定不能混淆
-keep public class com.ee.kclearup.entites.**{*;}
