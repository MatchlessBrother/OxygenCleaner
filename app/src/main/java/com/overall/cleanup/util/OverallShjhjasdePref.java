...
public class OverallShjhjasdePref {
    ...
    private static OverallShjhjasdePref prefsInstance;

    private OverallShjhjasdePref(@NonNull Context context) {
    ...
    private OverallShjhjasdePref(@NonNull Context context, @NonNull String preferencesName) {
        sharedPreferences = context.getApplicationContext().getSharedPreferences(
                preferencesName,
                Context.MODE_PRIVATE
        );
    ...
    /**
     * @param context
     * @return Returns a 'SharePref' instance
     */
    public static OverallShjhjasdePref with(@NonNull Context context) {
        if (prefsInstance == null) {
            prefsInstance = new OverallShjhjasdePref(context);
        }
     ...
     * @return Returns a 'SharePref' instance
     */
    public static OverallShjhjasdePref with(@NonNull Context context, boolean forceInstantiation) {
     ...
     * @return Returns a 'SharePref' instance
     */
    public static OverallShjhjasdePref with(@NonNull Context context, @NonNull String preferencesName) {
        if (prefsInstance == null) {
            prefsInstance = new OverallShjhjasdePref(context, preferencesName);
        }
        return prefsInstance;
    }
     ...
     * @return Returns a 'SharePref' instance
     */
    public static OverallShjhjasdePref with(@NonNull Context context, @NonNull String preferencesName, boolean forceInstantiation) {
        if (forceInstantiation) {
            prefsInstance = new OverallShjhjasdePref(context, preferencesName);
        }
        return prefsInstance;
