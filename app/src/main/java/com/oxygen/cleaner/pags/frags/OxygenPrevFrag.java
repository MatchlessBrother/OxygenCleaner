...
public class OxygenPrevFrag extends SimpleImmersionFragment
{
    ...
    public static OxygenPrevFrag newInstance()
    {
        Bundle args = new Bundle();
        OxygenPrevFrag fragment = new OxygenPrevFrag();
    ...
    private void addContent(LinearLayout containerView, List<String> nameAndValues)
    {
        ...
        if (nameAndValues.size() % 2 == 0)
        {
            ...
            for (int i = 0; i < nameAndValues.size(); i = i + 2)
            {
                ...
                params = new LinearLayout.LayoutParams(0, OxygenShdfUtil.dip2px(context, 40));
                params.weight = 1;
                nameView = new TextView(context);
                nameView.setText(nameAndValues.get(i));
                nameView.setTextSize(15);
                lineContainer.addView(nameView, params);
                params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, OxygenShdfUtil.dip2px(context, 30));
