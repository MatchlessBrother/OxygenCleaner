...
public abstract class OxygenAdapter_Recasdycler<T, V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<V> {
    ...
    public OxygenAdapter_Recasdycler() {
        ...
        public void onClick(View v) {
            ...
            if (itemClickListener != null) {
                if (itemClickListener instanceof OnAdapterClickListener) {
                    ((OnAdapterClickListener) itemClickListener).onItemClick((Integer) v.getTag(TAG_POSITION), v, OxygenAdapter_Recasdycler.this);
                } else {
    ...
    public abstract class OnAdapterClickListener<T> implements OnItemClickListener {
        ...
        abstract void onItemClick(int position, View target, OxygenAdapter_Recasdycler<T, ?> adapter);
    }
}
