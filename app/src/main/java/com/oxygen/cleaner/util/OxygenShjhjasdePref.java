...
public class OxygenShjhjasdePref {
    ...
    private static OxygenShjhjasdePref prefsInstance;

    private OxygenShjhjasdePref(@NonNull Context context) {
    ...
    private OxygenShjhjasdePref(@NonNull Context context, @NonNull String preferencesName) {
        sharedPreferences = context.getApplicationContext().getSharedPreferences(
                preferencesName,
                Context.MODE_PRIVATE
        );
     ...
     */
    public static OxygenShjhjasdePref with(@NonNull Context context) {
        if (prefsInstance == null) {
            prefsInstance = new OxygenShjhjasdePref(context);
        }
     ...
     * @return Returns a 'SharePref' instance
     */
    public static OxygenShjhjasdePref with(@NonNull Context context, boolean forceInstantiation) {
     ...
     * @return Returns a 'SharePref' instance
     */
    public static OxygenShjhjasdePref with(@NonNull Context context, @NonNull String preferencesName) {
        if (prefsInstance == null) {
            prefsInstance = new OxygenShjhjasdePref(context, preferencesName);
        }
        return prefsInstance;
    }
     ...
     * @return Returns a 'SharePref' instance
     */
    public static OxygenShjhjasdePref with(@NonNull Context context, @NonNull String preferencesName, boolean forceInstantiation) {
        if (forceInstantiation) {
            prefsInstance = new OxygenShjhjasdePref(context, preferencesName);
        }
        return prefsInstance;
