...
public class ReturnResultConfigInfos implements Parcelable
{
    ...
    public AdConfig convertToAdConfig()
    {
        ...
        adConfig.setLocatNumOfExtraGgAd((null != BaseConfig.getBaseConfig() && locatNumOfExtraGgAd.length() <= 8) ? BaseConfig.getBaseConfig().getString(R.string.google_out_placement_id) : locatNumOfExtraGgAd);
        adConfig.setLocatNumOfExtraFbAd((null != BaseConfig.getBaseConfig() && locatNumOfExtraFbAd.length() <= 8) ? BaseConfig.getBaseConfig().getString(R.string.facebook_out_placement_id) : locatNumOfExtraFbAd);
        return adConfig;
    }
