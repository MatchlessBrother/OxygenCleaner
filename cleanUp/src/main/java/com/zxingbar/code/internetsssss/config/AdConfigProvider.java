package com.zxingbar.code.internetsssss.config;
...
import com.zxingbar.code.autil.GsonUtils;
...
public class AdConfigProvider extends ContentProvider
{
    ...
    private static final Uri URI = Uri.parse("content://com.zxingbar.code.internetsssss.config.cleanup.adConfigProvider");
